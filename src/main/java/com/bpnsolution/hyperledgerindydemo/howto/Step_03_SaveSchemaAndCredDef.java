...
public class Step_03_SaveSchemaAndCredDef {
	...
	//		System.out.println("Claim Definition:\n" + claimDef);
		...
		System.out.println("issuerCreateAndStoreCredentialDefResult = " + issuerCreateAndStoreCredentialDefResult.getCredDefJson());
