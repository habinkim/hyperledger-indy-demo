...
import org.hyperledger.indy.sdk.anoncreds.CredentialRevokedException;
...
public class IndyException extends Exception {
	...
	public static IndyException fromSdkError(int sdkErrorCode) {
		...
		org.hyperledger.indy.sdk.ErrorCode errorCode = ErrorCode.valueOf(sdkErrorCode);
		...
		switch (errorCode) {
			...
			case WalletInvalidHandle:
				return new org.hyperledger.indy.sdk.wallet.InvalidWalletException();
			case WalletUnknownTypeError:
				return new org.hyperledger.indy.sdk.wallet.UnknownWalletTypeException();
			case WalletTypeAlreadyRegisteredError:
				return new org.hyperledger.indy.sdk.wallet.DuplicateWalletTypeException();
			case WalletAlreadyExistsError:
				return new org.hyperledger.indy.sdk.wallet.WalletExistsException();
			case WalletNotFoundError:
				return new org.hyperledger.indy.sdk.wallet.WalletNotFoundException();
			case WalletInputError:
				return new org.hyperledger.indy.sdk.wallet.WalletInputException();
			case WalletDecodingError:
				return new org.hyperledger.indy.sdk.wallet.WalletDecodingException();
			case WalletStorageError:
				return new org.hyperledger.indy.sdk.wallet.WalletStorageException();
			case WalletEncryptionError:
				return new org.hyperledger.indy.sdk.wallet.WalletEncryptionException();
			case WalletItemNotFound:
				return new org.hyperledger.indy.sdk.wallet.WalletItemNotFoundException();
			case WalletItemAlreadyExists:
				return new org.hyperledger.indy.sdk.wallet.WalletItemAlreadyExistsException();
			case WalletQueryError:
				return new org.hyperledger.indy.sdk.wallet.WalletInvalidQueryException();
			case WalletIncompatiblePoolError:
				return new WrongWalletForPoolException();
			case WalletAlreadyOpenedError:
				return new org.hyperledger.indy.sdk.wallet.WalletAlreadyOpenedException();
			case WalletAccessFailed:
				return new org.hyperledger.indy.sdk.wallet.WalletAccessFailedException();
			case PoolLedgerNotCreatedError:
				return new org.hyperledger.indy.sdk.pool.PoolConfigNotCreatedException();
			case PoolLedgerInvalidPoolHandle:
				return new org.hyperledger.indy.sdk.pool.InvalidPoolException();
			case PoolLedgerTerminated:
				return new org.hyperledger.indy.sdk.pool.PoolLedgerTerminatedException();
			...
			case PoolIncompatibleProtocolVersion:
				return new org.hyperledger.indy.sdk.pool.PoolIncompatibleProtocolVersionException();
			case LedgerNotFound:
				return new org.hyperledger.indy.sdk.pool.LedgerNotFoundException();
			case AnoncredsRevocationRegistryFullError:
				return new org.hyperledger.indy.sdk.anoncreds.RevocationRegistryFullException();
			case AnoncredsInvalidUserRevocId:
				return new org.hyperledger.indy.sdk.anoncreds.AnoncredsInvalidUserRevocId();
			case AnoncredsMasterSecretDuplicateNameError:
				return new org.hyperledger.indy.sdk.anoncreds.DuplicateMasterSecretNameException();
			case AnoncredsProofRejected:
				return new org.hyperledger.indy.sdk.anoncreds.ProofRejectedException();
			case AnoncredsCredentialRevoked:
				return new CredentialRevokedException();
			case AnoncredsCredDefAlreadyExistsError:
				return new org.hyperledger.indy.sdk.anoncreds.CredDefAlreadyExistsException();
			...
			case UnknownPaymentMethod:
				return new org.hyperledger.indy.sdk.payments.UnknownPaymentMethodException();
			case IncompatiblePaymentError:
				return new IncompatiblePaymentException();
			case InsufficientFundsError:
				return new org.hyperledger.indy.sdk.payments.InsufficientFundsException();
			case ExtraFundsError:
				return new org.hyperledger.indy.sdk.payments.ExtraFundsException();
			case PaymentSourceDoesNotExistError:
				return new org.hyperledger.indy.sdk.payments.PaymentSourceDoesNotExistException();
			case PaymentOperationNotSupportedError:
				return new org.hyperledger.indy.sdk.payments.PaymentOperationNotSupportedException();
			case TransactionNotAllowedError:
				return new org.hyperledger.indy.sdk.payments.TransactionNotAllowedException();
			default:
