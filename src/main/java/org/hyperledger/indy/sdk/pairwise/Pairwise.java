...
public class Pairwise extends IndyJava.API {
	...
	public static CompletableFuture<Boolean> isPairwiseExists(
			Wallet wallet,
			String theirDid) throws org.hyperledger.indy.sdk.IndyException {
		
		org.hyperledger.indy.sdk.ParamGuard.notNull(wallet, "wallet");
		org.hyperledger.indy.sdk.ParamGuard.notNullOrWhiteSpace(theirDid, "theirDid");
	...
	public static CompletableFuture<Void> createPairwise(
		...
		org.hyperledger.indy.sdk.ParamGuard.notNull(wallet, "wallet");
		org.hyperledger.indy.sdk.ParamGuard.notNullOrWhiteSpace(theirDid, "theirDid");
		org.hyperledger.indy.sdk.ParamGuard.notNullOrWhiteSpace(myDid, "myDid");	
