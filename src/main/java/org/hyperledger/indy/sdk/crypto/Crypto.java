...
import org.hyperledger.indy.sdk.Callbacks;
...
public class Crypto extends IndyJava.API {
	...
	public static CompletableFuture<String> createKey(
			Wallet wallet,
			String keyJson) throws org.hyperledger.indy.sdk.IndyException {

		org.hyperledger.indy.sdk.ParamGuard.notNull(wallet, "wallet");
		org.hyperledger.indy.sdk.ParamGuard.notNull(keyJson, "keyJson");
	...
	public static CompletableFuture<Void> setKeyMetadata(
		...
		org.hyperledger.indy.sdk.ParamGuard.notNull(wallet, "wallet");
		org.hyperledger.indy.sdk.ParamGuard.notNullOrWhiteSpace(verkey, "verkey");
	...
	public static CompletableFuture<byte[]> cryptoSign(
			Wallet wallet,
			String signerVk,
			byte[] message) throws org.hyperledger.indy.sdk.IndyException {

		org.hyperledger.indy.sdk.ParamGuard.notNull(wallet, "wallet");
		org.hyperledger.indy.sdk.ParamGuard.notNullOrWhiteSpace(signerVk, "signerVk");
		org.hyperledger.indy.sdk.ParamGuard.notNull(message, "message");
	...
	public static CompletableFuture<Boolean> cryptoVerify(
			String signerVk,
			byte[] message,
			byte[] signature) throws org.hyperledger.indy.sdk.IndyException {

		org.hyperledger.indy.sdk.ParamGuard.notNullOrWhiteSpace(signerVk, "theirVk");
		org.hyperledger.indy.sdk.ParamGuard.notNull(message, "message");
		org.hyperledger.indy.sdk.ParamGuard.notNull(signature, "signature");
	...
	public static CompletableFuture<byte[]> authCrypt(
		...
		org.hyperledger.indy.sdk.ParamGuard.notNull(wallet, "wallet");
		org.hyperledger.indy.sdk.ParamGuard.notNullOrWhiteSpace(senderVk, "myVk");
		org.hyperledger.indy.sdk.ParamGuard.notNullOrWhiteSpace(recipientVk, "theirVk");
		org.hyperledger.indy.sdk.ParamGuard.notNull(message, "message");
	...
	public static CompletableFuture<AuthDecryptResult> authDecrypt(
			Wallet wallet,
			String recipientVk,
			byte[] encryptedMsg) throws org.hyperledger.indy.sdk.IndyException {

		org.hyperledger.indy.sdk.ParamGuard.notNull(wallet, "wallet");
		org.hyperledger.indy.sdk.ParamGuard.notNullOrWhiteSpace(recipientVk, "myVk");
		org.hyperledger.indy.sdk.ParamGuard.notNull(encryptedMsg, "encryptedMsg");
	...
	public static CompletableFuture<byte[]> packMessage(
		...
		org.hyperledger.indy.sdk.ParamGuard.notNull(wallet, "wallet");
		org.hyperledger.indy.sdk.ParamGuard.notNull(message, "message");
		org.hyperledger.indy.sdk.ParamGuard.notNullOrWhiteSpace(recipientVk, "recipientVk");
