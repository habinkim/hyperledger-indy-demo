...
public class Ledger extends IndyJava.API {
	...
	public static CompletableFuture<String> signAndSubmitRequest(
			...
			Wallet wallet,
			String submitterDid,
			String requestJson) throws org.hyperledger.indy.sdk.IndyException {

		org.hyperledger.indy.sdk.ParamGuard.notNull(pool, "pool");
		org.hyperledger.indy.sdk.ParamGuard.notNull(wallet, "wallet");
		org.hyperledger.indy.sdk.ParamGuard.notNullOrWhiteSpace(submitterDid, "submitterDid");
		org.hyperledger.indy.sdk.ParamGuard.notNullOrWhiteSpace(requestJson, "requestJson");
	...
	public static CompletableFuture<String> submitAction(
			...
			String requestJson,
			String nodes,
			int timeout) throws org.hyperledger.indy.sdk.IndyException {
	...
	public static CompletableFuture<String> buildGetDdoRequest(
			String submitterDid,
			String targetDid) throws org.hyperledger.indy.sdk.IndyException {

		org.hyperledger.indy.sdk.ParamGuard.notNullOrWhiteSpace(targetDid, "targetDid");
	...
	public static CompletableFuture<String> buildNymRequest(
			...
			String verkey,
			String alias,
			String role) throws org.hyperledger.indy.sdk.IndyException {
	...
	public static CompletableFuture<String> buildAttribRequest(
			...
			String hash,
			String raw,
			String enc) throws org.hyperledger.indy.sdk.IndyException {
	...
	public static CompletableFuture<String> parseGetNymResponse(
			String response) throws org.hyperledger.indy.sdk.IndyException {

		org.hyperledger.indy.sdk.ParamGuard.notNull(response, "response");
	...
	public static CompletableFuture<String> buildSchemaRequest(
			String submitterDid,
			String data) throws org.hyperledger.indy.sdk.IndyException {

		org.hyperledger.indy.sdk.ParamGuard.notNullOrWhiteSpace(submitterDid, "submitterDid");
		org.hyperledger.indy.sdk.ParamGuard.notNullOrWhiteSpace(data, "data");
	...
	public static CompletableFuture<String> buildGetSchemaRequest(
			String submitterDid,
			String id) throws org.hyperledger.indy.sdk.IndyException {

		org.hyperledger.indy.sdk.ParamGuard.notNullOrWhiteSpace(id, "id");
	...
	public static CompletableFuture<ParseResponseResult> parseGetSchemaResponse(
			String getSchemaResponse) throws org.hyperledger.indy.sdk.IndyException {

		org.hyperledger.indy.sdk.ParamGuard.notNullOrWhiteSpace(getSchemaResponse, "data");
	...
	public static CompletableFuture<ParseResponseResult> parseGetCredDefResponse(
			String getCredDefResponse) throws org.hyperledger.indy.sdk.IndyException {

		org.hyperledger.indy.sdk.ParamGuard.notNullOrWhiteSpace(getCredDefResponse, "getCredDefResponse");
	...
	public static CompletableFuture<String> buildGetValidatorInfoRequest(
			String submitterDid) throws org.hyperledger.indy.sdk.IndyException {
	...
	public static CompletableFuture<String> buildGetTxnRequest(
			String submitterDid,
			String ledgerType,
			int seqNo) throws org.hyperledger.indy.sdk.IndyException {
	...
	public static CompletableFuture<String> buildPoolConfigRequest(
			String submitterDid,
			boolean writes,
			boolean force) throws org.hyperledger.indy.sdk.IndyException {
	...
	public static CompletableFuture<String> buildPoolRestartRequest(
			String submitterDid,
			String action,
			String datetime) throws org.hyperledger.indy.sdk.IndyException {
	...
	public static CompletableFuture<String> buildPoolUpgradeRequest(
			...
			boolean reinstall,
			boolean force,
			String package_) throws org.hyperledger.indy.sdk.IndyException {
	...
	public static CompletableFuture<ParseResponseResult> parseGetRevocRegDefResponse(
			String getRevocRegDefResponse) throws org.hyperledger.indy.sdk.IndyException {

		org.hyperledger.indy.sdk.ParamGuard.notNullOrWhiteSpace(getRevocRegDefResponse, "data");
	...
	public static CompletableFuture<String> buildRevocRegEntryRequest(
			...
			String revDefType,
			String value) throws org.hyperledger.indy.sdk.IndyException {

		org.hyperledger.indy.sdk.ParamGuard.notNullOrWhiteSpace(submitterDid, "submitterDid");
		org.hyperledger.indy.sdk.ParamGuard.notNullOrWhiteSpace(revocRegDefId, "revocRegDefId");
		org.hyperledger.indy.sdk.ParamGuard.notNullOrWhiteSpace(revDefType, "revDefType");
	...
	public static CompletableFuture<String> buildGetRevocRegRequest(
			String submitterDid,
			String revocRegDefId,
			long timestamp) throws org.hyperledger.indy.sdk.IndyException {

		org.hyperledger.indy.sdk.ParamGuard.notNullOrWhiteSpace(revocRegDefId, "id");
	...
	public static CompletableFuture<ParseRegistryResponseResult> parseGetRevocRegResponse(
			String getRevocRegResponse) throws org.hyperledger.indy.sdk.IndyException {

		org.hyperledger.indy.sdk.ParamGuard.notNullOrWhiteSpace(getRevocRegResponse, "data");
	...
	public static CompletableFuture<String> buildGetRevocRegDeltaRequest(
			...
			String revocRegDefId,
			long from,
			long to) throws org.hyperledger.indy.sdk.IndyException {
	...
	public static CompletableFuture<ParseRegistryResponseResult> parseGetRevocRegDeltaResponse(
			String getRevocRegDeltaResponse) throws org.hyperledger.indy.sdk.IndyException {

		org.hyperledger.indy.sdk.ParamGuard.notNullOrWhiteSpace(getRevocRegDeltaResponse, "data");
	...
	public static CompletableFuture<String> getResponseMetadata(
		...
		org.hyperledger.indy.sdk.ParamGuard.notNullOrWhiteSpace(response, "response");
	...
	public static CompletableFuture<String> buildAuthRuleRequest(
			...
			String oldValue,
			String newValue,
			String constraint) throws org.hyperledger.indy.sdk.IndyException {

		org.hyperledger.indy.sdk.ParamGuard.notNullOrWhiteSpace(submitterDid, "submitterDid");
		org.hyperledger.indy.sdk.ParamGuard.notNullOrWhiteSpace(txnType, "txnType");
		org.hyperledger.indy.sdk.ParamGuard.notNullOrWhiteSpace(action, "action");
	...
	public static CompletableFuture<String> buildAuthRulesRequest(
		...
		org.hyperledger.indy.sdk.ParamGuard.notNullOrWhiteSpace(submitterDid, "submitterDid");
		org.hyperledger.indy.sdk.ParamGuard.notNull(data, "data");
	...
	public static CompletableFuture<String> buildGetAuthRuleRequest(
			...
			String field,
			String oldValue,
			String newValue) throws org.hyperledger.indy.sdk.IndyException {
	...
	public static CompletableFuture<String> buildTxnAuthorAgreementRequest(
			...
			long retirementTimestamp) throws org.hyperledger.indy.sdk.IndyException {

		org.hyperledger.indy.sdk.ParamGuard.notNullOrWhiteSpace(submitterDid, "submitterDid");
		org.hyperledger.indy.sdk.ParamGuard.notNull(version, "version");
	...
	public static CompletableFuture<String> buildAcceptanceMechanismsRequest(
			...
			String aml,
			String version,
			String amlContext) throws org.hyperledger.indy.sdk.IndyException {

		org.hyperledger.indy.sdk.ParamGuard.notNullOrWhiteSpace(submitterDid, "submitterDid");
		org.hyperledger.indy.sdk.ParamGuard.notNull(aml, "aml");
		org.hyperledger.indy.sdk.ParamGuard.notNull(version, "version");
	...
	public static CompletableFuture<String> buildGetAcceptanceMechanismsRequest(
			String submitterDid,
			int timestamp,
			String version) throws org.hyperledger.indy.sdk.IndyException {
	...
	public static CompletableFuture<String> appendTxnAuthorAgreementAcceptanceToRequest(
			...
			String taaDigest,
			String mechanism,
			long time) throws org.hyperledger.indy.sdk.IndyException {

		org.hyperledger.indy.sdk.ParamGuard.notNull(requestJson, "requestJson");
		org.hyperledger.indy.sdk.ParamGuard.notNull(mechanism, "mechanism");
	...
	public static CompletableFuture<String> appendRequestEndorser(
			String requestJson,
			String endorserDid) throws org.hyperledger.indy.sdk.IndyException {

		org.hyperledger.indy.sdk.ParamGuard.notNull(requestJson, "requestJson");
		org.hyperledger.indy.sdk.ParamGuard.notNull(endorserDid, "endorserDid");
	 ...
	 * @throws org.hyperledger.indy.sdk.IndyException Thrown if an error occurs when calling the underlying SDK.
	 */
	public static CompletableFuture<String> buildLedgersFreezeRequest(String submitterDid, List<Integer> ledgersIds) throws org.hyperledger.indy.sdk.IndyException {
		org.hyperledger.indy.sdk.ParamGuard.notNullOrWhiteSpace(submitterDid, "submitterDid");
