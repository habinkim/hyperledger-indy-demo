...
public class WalletSearch extends IndyJava.API implements AutoCloseable {
	...
	public static CompletableFuture<WalletSearch> open(
			...
			String type,
			String queryJson,
			String optionsJson) throws org.hyperledger.indy.sdk.IndyException {

		org.hyperledger.indy.sdk.ParamGuard.notNull(wallet, "wallet");
		org.hyperledger.indy.sdk.ParamGuard.notNullOrWhiteSpace(type, "type");
		org.hyperledger.indy.sdk.ParamGuard.notNull(queryJson, "queryJson");
	...
	public static CompletableFuture<String> searchFetchNextRecords(
			Wallet wallet,
			WalletSearch search,
			int count) throws org.hyperledger.indy.sdk.IndyException {
	...
	public static CompletableFuture<Void> closeSearch(
			WalletSearch search) throws org.hyperledger.indy.sdk.IndyException {
