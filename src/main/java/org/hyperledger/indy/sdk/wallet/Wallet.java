...
public class Wallet extends IndyJava.API implements AutoCloseable {
	 ...
	 * @throws org.hyperledger.indy.sdk.IndyException Thrown if a call to the underlying SDK fails.
	 */
	public static CompletableFuture<Void> createWallet(
			String config,
			String credentials) throws org.hyperledger.indy.sdk.IndyException {
	...
	private static CompletableFuture<Void> closeWallet(
			Wallet wallet) throws org.hyperledger.indy.sdk.IndyException {
	...
	public static CompletableFuture<Void> exportWallet(
			Wallet wallet,
			String exportConfigJson) throws org.hyperledger.indy.sdk.IndyException {

		org.hyperledger.indy.sdk.ParamGuard.notNull(wallet, "wallet");
		org.hyperledger.indy.sdk.ParamGuard.notNull(exportConfigJson, "exportConfigJson");
	...
	public static CompletableFuture<Void> importWallet(
			String config,
			String credentials,
			String importConfigJson) throws org.hyperledger.indy.sdk.IndyException {
	...
	public static CompletableFuture<String> generateWalletKey(
			String config) throws org.hyperledger.indy.sdk.IndyException {
	...
	public CompletableFuture<Void> closeWallet(
			) throws org.hyperledger.indy.sdk.IndyException {
