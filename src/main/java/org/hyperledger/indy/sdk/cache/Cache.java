...
public class Cache extends IndyJava.API {
	...
	public static CompletableFuture<Void> purgeSchemaCache(
		...
		org.hyperledger.indy.sdk.ParamGuard.notNull(optionsJson, "optionsJson");
	...
	public static CompletableFuture<String> getSchema(
		...
		org.hyperledger.indy.sdk.ParamGuard.notNull(wallet, "wallet");
		org.hyperledger.indy.sdk.ParamGuard.notNull(submitterDid, "submitterDid");
		org.hyperledger.indy.sdk.ParamGuard.notNull(id, "id");
		org.hyperledger.indy.sdk.ParamGuard.notNull(optionsJson, "optionsJson");
